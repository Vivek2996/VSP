        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <span class="icon-bar"></span>
              ...
              <h1><img class="img-responsive" src="images/bteslogo.jpeg" alt="logo" height="250" width="150"></h1></a>
         </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
           <li class="scroll active"><a href="home.html">Home</a></li>                  
            <li class="scroll"><a href="dem.jsp">Course details</a></li>
            <li class="scroll"><a href="mail.jsp">Chat BoX</a></li>
            <li class="scroll"><a href="To.jsp">Admission Test</a></li>  
          </ul>
      </div>
    </div><!--/#main-nav-->
  </header><!--/#home-->
